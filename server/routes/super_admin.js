...
router.post('/panel_de_control', upload2.single('imagen'), super_adminController.subirTable);
router.get('/panel_de_control',verificarToken, verificarRol(['admin', 'super_admin']),super_adminController.obtenerTablas);
router.delete('/panel_de_control/:id', verificarToken, super_adminController.eliminarTabla);
router.put('/panel_de_control/:id', upload2.single('imagen'), super_adminController.actulizarTabla );
